...
type HolidayLike = { date?: string; name?: string } | string;
type ClosureLike = { start?: string; end?: string; name?: string };

type RendererOptions = {
    document: Document;
    getCalendar: () => any;
    setCachedData: (data: any) => void;
    summaryUi?: { renderSummary: (data: any) => void };
    pendingUi?: { renderPendingList: (data: any) => void };
    applyCalendarListStyles: (document: Document) => void;
    applyCalendarListHoverStyles: (document: Document) => void;
    getTypeColor: (type?: string) => string;
    shouldIncludeRequest: (request: RequestLike) => boolean;
};
...
function createRenderer(options: RendererOptions) {
    ...
    function buildEventFromRequest(request: RequestLike) {
    ...
    function renderCalendar(data: { requests?: RequestLike[]; holidays?: HolidayLike[]; closures?: ClosureLike[] }) {
    ...
    function renderAll(data: { requests?: RequestLike[]; holidays?: HolidayLike[]; closures?: ClosureLike[] }) {
...
if (typeof module !== "undefined" && module.exports && !(globalThis as any).__aypiBundled) {
    if (typeof module !== "undefined" && module.exports && !(globalThis as any).__aypiBundled) module.exports = { createRenderer };
}
